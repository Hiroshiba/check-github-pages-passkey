/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 29f43d23df2833fd68fbc6ef3eede9cf)
// Runtime types generated with workerd@1.20260722.1 2026-08-03 nodejs_compat
interface __BaseEnv_Env {
	DEPLOYMENT_REQUESTS: KVNamespace;
	ASSETS: Fetcher;
	ACCESS_AUD: "d480b67ee970699f65b005edc24c9fd50662465992342415b8fff3c57eddb0cc";
	ACCESS_TEAM_DOMAIN: "https://voicevox-oss-01.cloudflareaccess.com";
	ALLOWED_APPROVER_EMAILS: ["voicevox.oss@gmail.com","hihokaruta@gmail.com"];
	ALLOWED_ENVIRONMENT: "github-pages";
	ALLOWED_REPOSITORY: "Hiroshiba/check-github-pages-passkey";
	ALLOWED_REPOSITORY_ID: "1320267202";
	ALLOWED_WORKFLOW_PATH: ".github/workflows/deploy-pages.yml";
	ALLOWED_WORKFLOW_REF: "refs/heads/production";
	EXPECTED_WORKFLOW_SHA: "aba78a32b177696ecfe258155ecbd7d1eb1c1424";
	GITHUB_APP_CLIENT_ID: "Iv23liFVBGJBRsob9dZr";
	DECISION_TOKEN_SECRET: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ACCESS_AUD" | "ACCESS_TEAM_DOMAIN" | "ALLOWED_APPROVER_EMAILS" | "ALLOWED_ENVIRONMENT" | "ALLOWED_REPOSITORY" | "ALLOWED_REPOSITORY_ID" | "ALLOWED_WORKFLOW_PATH" | "ALLOWED_WORKFLOW_REF" | "EXPECTED_WORKFLOW_SHA" | "GITHUB_APP_CLIENT_ID" | "DECISION_TOKEN_SECRET" | "GITHUB_APP_PRIVATE_KEY" | "GITHUB_WEBHOOK_SECRET">> {}
}
